...
- **Skill oficial (Stellar):** o plugin de Claude Code de Caatinga — [`ctg-skills`](https://github.com/Dione-b/caatinga-skill) (`/plugin marketplace add Dione-b/caatinga-skill` → `/plugin install caatinga-skill@caatinga-skill`) — está listado como **official Stellar skill** em [skills.stellar.org](https://skills.stellar.org/). Já referenciado em `caatinga/README.md` e `caatinga/docs/tutorials/integration-guide.md`; precisa de entrada própria em **Resources** (ver estrutura de navegação acima, link para skills.stellar.org) e menção na Sprint 27 (CI/CD) ou Sprint 9 (Getting Started) como forma recomendada de usar Caatinga com agentes de IA.
...
└── Resources
    ...
    ├── Examples
    ├── Ecosystem
    └── Stellar Skill (skills.stellar.org)
```
